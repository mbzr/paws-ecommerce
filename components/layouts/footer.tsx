...
export const Footer: React.FC = () => {
  return (
    <footer className="site-footer bg-brand-primary text-white text-sm">
      <div className=" py-8 lg:pt-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {/* Customer Service */}
            <div className="">
              <div className="text-lg font-bold mb-4 font-heading">
                Customer Service
              </div>
              <ul className="list-none p-0 m-0 mb-5 md:mb-0">
                <li>
                  <a
            ...
            <div className="">
              ...
              <ul className="list-none p-0 m-0 mb-5 md:mb-0">
                <li>
                  <a href="/pages/about-us" className="inline-block py-1">
                    About PAWS
                  </a>
                </li>
                <li>
                  <a href="/pages/contact" className="inline-block py-1">
                    Contact Us
                  </a>
                </li>
              </ul>
            ...
            {/* Get in touch & Follow us (Mobile section) */}
            <div className="flex-1 max-w-xs md:max-w-none md:flex-1 lg:flex-1 sm:ml-[-1rem] sm:mr-[-1rem] sm:px-4">
                ...
                <div className="flex-1 sm:flex-none">
                  ...
                  <ul className="list-none p-0 m-0 flex flex-wrap items-center">
                    {socialLinks.map((link) => (
                      <li key={link.name} className="mr-4 mb-4">
                        <a
                          target="_blank"
                          rel="noopener nofollow"
                          href={link.href}
                          title={`PAWS Pet Store on ${link.name}`}
                          className="block"
                        >
                          {link.icon}
            ...
            {/* Payment methods */}
            <div className=" sm:ml-[-1rem] sm:mr-[-1rem] sm:px-4">
              <div className="flex flex-wrap justify-center sm:block">
                <div className="flex-1 sm:flex-none">
                  <div className="text-lg font-bold mb-4 font-heading">
                    We accept
                  </div>
                  <ul className="inline-flex flex-wrap items-center mb-5 md:mb-0">
                    {paymentIcons.map((icon) => (
                      <li key={icon.name} className="cursor-default mr-2 mb-1">
                        {icon.svg}
                      </li>
                    ))}
                  </ul>
